...
// please not i have not added this file in this direct there this error is showing Replace The "#include" File Below With The CPU Relevant One For Your Board
#include "stm3214xx.h"
